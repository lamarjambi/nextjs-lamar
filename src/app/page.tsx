      ...
      <header className="px-24 pt-8 pb-6">
        <div className="flex items-end justify-between gap-4 flex-wrap">
          ...
          <div className="flex gap-3 items-center pb-1">
            <a href="/files/lamar_jambi_resume.pdf" target="_blank" rel="noopener noreferrer" title="Resume">
            ...
            <a href="mailto:play.lmjambi@gmail.com" title="Email">
              <div className="w-10 h-10 bg-[#EC6BA7] rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#547DFD] transition-all">
            ...
            <a href="https://www.linkedin.com/in/lamar-jambi/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
              <div className="w-10 h-10 bg-[#EC6BA7] rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#547DFD] transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="white" viewBox="0 0 16 16">
            ...
            <a href="https://playlamar.itch.io/" target="_blank" rel="noopener noreferrer" title="itch.io">
              <div className="w-10 h-10 bg-[#EC6BA7] rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#547DFD] transition-all">
            ...
            <a href="https://github.com/lamarjambi" target="_blank" rel="noopener noreferrer" title="GitHub">
              <div className="w-10 h-10 bg-[#EC6BA7] rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#547DFD] transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" viewBox="0 0 16 16">
            ...
            <a href="https://twitter.com/playlamar" target="_blank" rel="noopener noreferrer" title="Twitter / X">
              <div className="w-10 h-10 bg-[#EC6BA7] rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#547DFD] transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="white" viewBox="0 0 16 16">
