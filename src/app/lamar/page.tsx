  ...
  const cards = [
    {
      ...
      blurb: "I play lots and lots of Splatoon 3 :] It's my favorite competitive game, but my top 3 are probably World's End Club, Octopath Traveler, and (guilty pleasure) Monster Prom: XXL :]",
      rotate: -10,
      tx: "-13vw",
      ty: "-5vh",
    },
    {
      ...
      color: "bg-[#FDD23B]",
      label: "what do I do",
      blurb: "I make art!!!! Which is, often, through building games; my fondest childhood memories always revolved around laying on the floor and playing Flash Games with my cousins :P",
      rotate: 1,
      tx: "-1vw",
      ty: "2vh",
    },
