...
export default function GamePage() {
  ...
  const cards = [
    { 
      id: 1,
      category: "Games",
      color: "bg-gradient-to-br from-[#75C2DF] to-[#FAF0DD] hover:from-[#75C2DF] hover:to-[#75C2DF]",
      items: [
    ...
    { 
      id: 2,
      category: "Experience",
      color: "bg-gradient-to-br from-[#FDD23B] to-[#C9A0DF] hover:from-[#FDD23B] hover:to-[#FDD23B]",
      items: [
    ...
    { 
      id: 3,
      category: "Skills",
      color: "bg-gradient-to-br from-[#EC6BA7] to-[#81C950] hover:from-[#EC6BA7] hover:to-[#EC6BA7]",
      items: [
